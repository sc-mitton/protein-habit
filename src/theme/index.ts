...
const lightTheme = createTheme({
  colors: {
    ...
    // Accent colors
    yellow: "#c09d34",
    yellowGradientStart: "#c09d34",
    yellowGradientEnd: "#967d29",
    yellowText: "#967d29",
    orange: "#d97126",
    orangeGradientStart: "#d97126",
    orangeGradientEnd: "#ad5a1e",
    orangeText: "#ad5a1e",
    green: "#127e5f",
    greenGradientStart: "#127e5f",
    greenGradientEnd: "#0e654c",
    greenText: "#0e654c",
    blue: "#637eea",
    blueGradientStart: "#637eea",
    blueGradientEnd: "#8b7efc",
    blueText: "#4b62d1",
    purple: "#af69de",
    purpleGradientStart: "#af69de",
    purpleGradientEnd: "#8c54b2",
    purpleText: "#8c54b2",
    pink: "#db6ca3",
    pinkGradientStart: "#db6ca3",
    pinkGradientEnd: "#af5682",
    pinkText: "#af5682",
    red: "#bf4044",
    redGradientStart: "#bf4044",
    redGradientEnd: "#993336",
    redText: "#993336",
  },
  spacing: {
    nl: -24,
