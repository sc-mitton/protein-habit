...
CREATE TABLE `__new_cuisines` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_cuisines`("id", "name") SELECT "id", "name" FROM `cuisines`;--> statement-breakpoint
DROP TABLE `cuisines`;--> statement-breakpoint
ALTER TABLE `__new_cuisines` RENAME TO `cuisines`;--> statement-breakpoint
PRAGMA foreign_keys=ON;--> statement-breakpoint
CREATE UNIQUE INDEX `cuisines_name_unique` ON `cuisines` (`name`);--> statement-breakpoint
CREATE TABLE `__new_dish_types` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_dish_types`("id", "name") SELECT "id", "name" FROM `dish_types`;--> statement-breakpoint
DROP TABLE `dish_types`;--> statement-breakpoint
ALTER TABLE `__new_dish_types` RENAME TO `dish_types`;--> statement-breakpoint
CREATE UNIQUE INDEX `dish_types_name_unique` ON `dish_types` (`name`);--> statement-breakpoint
CREATE TABLE `__new_meal_types` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_meal_types`("id", "name") SELECT "id", "name" FROM `meal_types`;--> statement-breakpoint
DROP TABLE `meal_types`;--> statement-breakpoint
ALTER TABLE `__new_meal_types` RENAME TO `meal_types`;--> statement-breakpoint
...
CREATE TABLE `__new_proteins` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_proteins`("id", "name") SELECT "id", "name" FROM `proteins`;--> statement-breakpoint
DROP TABLE `proteins`;--> statement-breakpoint
ALTER TABLE `__new_proteins` RENAME TO `proteins`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_recipes`("id", "title", "ingredients", "instructions", "thumbnail", "last_seen", "created_on") SELECT "id", "title", "ingredients", "instructions", "thumbnail", "last_seen", "created_on" FROM `recipes`;--> statement-breakpoint
